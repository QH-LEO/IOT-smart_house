...
public class MyWebSocketServerHandler extends
	...
	private void handlerWebSocketFrame(ChannelHandlerContext ctx,
                                       WebSocketFrame frame) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
		...
		String url1=handshaker.uri().split("/")[4];
		String url2=handshaker.uri().split("/")[5];
		...
		Class c= null;
		try {
			c = Class.forName("org.verify."+url);
		...
		Method doj1=cls.getMethod(url1, login.class);
//		String json= null;
...
//		}
		String json= null;
		try {
			json = (String) doj1.invoke(object,request);
		} catch (IllegalAccessException e) {
			e.printStackTrace();
